...
public:
	...
	void SetModel(const char* szModel) { addresses::CBaseModelEntity_SetModel(this, szModel); }

	const char* GetModelName() { return ((CSkeletonInstance*)m_CBodyComponent->m_pSceneNode.Get())->m_modelState().m_ModelName.Get().String(); }
};